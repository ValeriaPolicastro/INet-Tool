...
- Gene_Expression a subset of Gene expression data
- Methy_Expression a subset of Methylation data
- Mirna_Expression a subset of Mirna data 
from 215 patients with Glioblastoma.

# How to construct the Networks
To construct 3 patient network
```{r, construction}
